...
### Uppgift 1 - Grundläggande array

```react:demo title="Uppgift 1 - Grundläggande array"
...
### Uppgift 2 - Array bounds

```react:demo title="Uppgift 2 - Array bounds fel"
...
### Uppgift 3 - Tilldela och skriv ut värden
...
```react:demo title="Uppgift 3 - Tilldela och skriv ut"
...
### Uppgift 4 - Array med värden och omvänd ordning
...
```react:demo title="Uppgift 4 - Omvänd ordning"
...
### Uppgift 5 - Array med 100 element och summering
...
```react:demo title="Uppgift 5 - 100 element och summering"
...
```react:demo title="Uppgift 6 - Slump och sortering"
import java.util.Random;
